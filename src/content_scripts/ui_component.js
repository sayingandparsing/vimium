...
class UIComponent {
  ...
  constructor(iframeUrl, className, handleMessage) {
    ...
    DomUtils.documentReady(() => {
      ...
      return this.iframePort = new AsyncDataFetcher((setIframePort) => {
        ...
        return this.iframeElement.addEventListener('load', () => chrome.storage.local.get('vimiumSecret', ({ vimiumSecret }) => {
  ...
  postMessage(message = null, continuation = null) {
    return (this.iframePort != null ? this.iframePort.use((port) => {
